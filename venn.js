    ...
    venn.VennDiagram = function() {
        ...
        function chart(selection) {
            ...
            var pathTween = function(d) {
                return function(t) {
                    var c = d.sets.map(function(set) {
                        ...
                        if (!start) {
                            start = {x : vanishing_point.x, y : vanishing_point.y, radius : vanishing_radius};
                        }
                        if (!end) {
                            end = {x : vanishing_point.x, y : vanishing_point.y, radius : vanishing_radius};
                        }
            ...
            var enterText = enter.append("text")
                ...
                .attr("dy", ".35em")
                .attr("x", vanishing_point.x)
                .attr("y", vanishing_point.y)
            .attr("fill-opacity", 0);
